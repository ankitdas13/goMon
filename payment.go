...
// Returns the unmodified JSON received from the API
func (r PaymentAcquirerData) RawJSON() string { return r.JSON.raw }
...
// Returns the unmodified JSON received from the API
func (r RefundAcquirerData) RawJSON() string { return r.JSON.raw }
...
func (r PaymentNewRefundParams) MarshalJSON() (data []byte, err error) {
	type shadow PaymentNewRefundParams
	return param.MarshalObject(r, (*shadow)(&r))
}
...
// URLQuery serializes [PaymentListRefundsParams]'s query parameters as
// `url.Values`.
