...
<a href="https://pkg.go.dev/github.com/stainless-sdks/gomon-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/gomon-go.svg" alt="Go Reference"></a>

The Gomon Go library provides convenient access to the [Gomon REST API](https://razorpay.com/docs/api)
...
```go
import (
	"github.com/stainless-sdks/gomon-go" // imported as gomon
)
```
...
```sh
go get -u 'github.com/stainless-sdks/gomon-go@v0.0.1-alpha.0'
```
...
The gomon library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/gomon-go/option).
...
`*gomon.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `gomon.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/gomon-go/issues) with questions, bugs, or suggestions.
