...
// interacting with the gomon API. You should not instantiate this client directly,
...
// DefaultClientOptions read from the environment (GOMON_USERNAME, GOMON_PASSWORD,
// GOMON_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("GOMON_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("GOMON_USERNAME"); ok {
		defaults = append(defaults, option.WithUsername(o))
	}
	if o, ok := os.LookupEnv("GOMON_PASSWORD"); ok {
...
// environment (GOMON_USERNAME, GOMON_PASSWORD, GOMON_BASE_URL). The option passed
