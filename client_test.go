...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Orders.List(context.Background(), gomon.OrderListParams{})
	if userAgent != fmt.Sprintf("Gomon/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Orders.List(context.Background(), gomon.OrderListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Orders.List(cancelCtx, gomon.OrderListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Orders.List(deadlineCtx, gomon.OrderListParams{})
		if err == nil {
